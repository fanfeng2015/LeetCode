...
//    otherwise return -1; 
// 2. put(key,value): set or insert the value if the key is not already present. When the cache reaches
//    its capacity, it should invalidate the least frequently used item before inserting a new item.
//    For the purpose of this problem, when there is a tie (i.e., two or more keys have the same frequency),
